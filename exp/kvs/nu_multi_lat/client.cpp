...
constexpr static netaddr kClientAddrs[] = {
    ...
    {.ip = MAKE_IP_ADDR(18, 18, 1, 40), .port = 9000},
    {.ip = MAKE_IP_ADDR(18, 18, 1, 42), .port = 9000},
};
constexpr uint32_t kProxyPort = 10086;
constexpr uint32_t kNumThreads = 250;
constexpr double kTargetMops = 160;
constexpr uint32_t kWarmupUs = 1 * kOneSecond;
constexpr uint32_t kDurationUs = 10 * kOneSecond;
