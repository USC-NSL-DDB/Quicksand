...
mops=( 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 )
...
do
	...
	sleep 5
	ssh $ip "cd $SOCIAL_NET_DIR; sudo build/src/BackEndService $conf SRV $CTRL_IP $LPID"&
    done
    sleep 5
    ...
    sleep 5
    sudo build/bench/client $DIR/conf/client2 CLT 1>$DIR/logs/$num_worker_nodes 2>&1
    for i in `seq 1 $num_worker_nodes`
    do
        ip=${REMOTE_SERVER_IPS[`expr $i - 1`]}
