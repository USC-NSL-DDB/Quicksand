...
constexpr static netaddr kClientAddrs[] = {
    {.ip = MAKE_IP_ADDR(18, 18, 1, 201), .port = 9000},
    {.ip = MAKE_IP_ADDR(18, 18, 1, 202), .port = 9000},
    {.ip = MAKE_IP_ADDR(18, 18, 1, 203), .port = 9000},
    {.ip = MAKE_IP_ADDR(18, 18, 1, 204), .port = 9000},
    {.ip = MAKE_IP_ADDR(18, 18, 1, 205), .port = 9000},
};
