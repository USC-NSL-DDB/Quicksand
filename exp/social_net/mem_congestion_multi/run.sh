...
PROXY_IPS=( $SERVER2_IP $SERVER3_IP $SERVER4_IP $SERVER5_IP $SERVER6_IP $SERVER7_IP $SERVER8_IP $SERVER9_IP $SERVER10_IP $SERVER11_IP \
            ...
            $SERVER22_IP $SERVER23_IP $SERVER24_IP $SERVER25_IP $SERVER26_IP )
CLIENT_IPS=( $SERVER27_IP $SERVER28_IP $SERVER29_IP $SERVER30_IP $SERVER31_IP )
NGINX_IP=$SERVER32_IP
...
sleep 5
sudo $NU_DIR/bin/ctrl_main $DIR/conf/controller >logs/controller &
