...
cp $NU_DIR/inc/nu/dis_executor.hpp $NU_DIR/inc/nu/dis_executor.hpp.bak
sed "s/\(.*\)kAdjustNumWorkersIntervalUs = .*/\1kAdjustNumWorkersIntervalUs = 200000;/g" \
    -i $NU_DIR/inc/nu/dis_executor.hpp
...
mv $NU_DIR/inc/nu/dis_executor.hpp.bak $NU_DIR/inc/nu/dis_executor.hpp
