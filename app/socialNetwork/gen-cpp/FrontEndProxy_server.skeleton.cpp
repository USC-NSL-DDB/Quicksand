...
class FrontEndProxyHandler : virtual public FrontEndProxyIf {
 public:
...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<FrontEndProxyHandler> handler(new FrontEndProxyHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new FrontEndProxyProcessor(handler));
