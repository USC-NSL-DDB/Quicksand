        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->usernames.resize(_size133);
            uint32_t _i137;
            for (_i137 = 0; _i137 < _size133; ++_i137)
            {
              xfer += iprot->readString(this->usernames[_i137]);
            }
...
uint32_t UserMentionService_ComposeUserMentions_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("usernames", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter138 = this->usernames.begin(); _iter138 != this->usernames.end(); ++_iter138)
    {
...
uint32_t UserMentionService_ComposeUserMentions_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("usernames", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter139 = (*(this->usernames)).begin(); _iter139 != (*(this->usernames)).end(); ++_iter139)
    {
...
uint32_t UserMentionService_ComposeUserMentions_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<UserMention> ::const_iterator _iter145;
...
void UserMentionServiceClient::ComposeUserMentions(std::vector<UserMention> & _return, const int64_t req_id, const std::vector<std::string> & usernames)
{
  send_ComposeUserMentions(req_id, usernames);
  recv_ComposeUserMentions(_return);
}

void UserMentionServiceClient::send_ComposeUserMentions(const int64_t req_id, const std::vector<std::string> & usernames)
{
  int32_t cseqid = 0;
...
void UserMentionServiceProcessor::process_ComposeUserMentions(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ComposeUserMentions(result.success, args.req_id, args.usernames);
...
void UserMentionServiceConcurrentClient::ComposeUserMentions(std::vector<UserMention> & _return, const int64_t req_id, const std::vector<std::string> & usernames)
{
  int32_t seqid = send_ComposeUserMentions(req_id, usernames);
  recv_ComposeUserMentions(_return, seqid);
}

int32_t UserMentionServiceConcurrentClient::send_ComposeUserMentions(const int64_t req_id, const std::vector<std::string> & usernames)
{
