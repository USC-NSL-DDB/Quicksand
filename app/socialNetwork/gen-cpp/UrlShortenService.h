...
class UrlShortenServiceIf {
 public:
  ...
  virtual void ComposeUrls(std::vector<Url> & _return, const int64_t req_id, const std::vector<std::string> & urls) = 0;
...
class UrlShortenServiceNull : virtual public UrlShortenServiceIf {
 public:
  ...
  void ComposeUrls(std::vector<Url> & /* _return */, const int64_t /* req_id */, const std::vector<std::string> & /* urls */) {
    return;
  }
...
typedef struct _UrlShortenService_ComposeUrls_args__isset {
  _UrlShortenService_ComposeUrls_args__isset() : req_id(false), urls(false) {}
  bool req_id :1;
  bool urls :1;
...
class UrlShortenServiceClient : virtual public UrlShortenServiceIf {
 ...
 public:
  ...
  void ComposeUrls(std::vector<Url> & _return, const int64_t req_id, const std::vector<std::string> & urls);
  void send_ComposeUrls(const int64_t req_id, const std::vector<std::string> & urls);
...
class UrlShortenServiceMultiface : virtual public UrlShortenServiceIf {
 ...
 public:
  void ComposeUrls(std::vector<Url> & _return, const int64_t req_id, const std::vector<std::string> & urls) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ComposeUrls(_return, req_id, urls);
    }
    ifaces_[i]->ComposeUrls(_return, req_id, urls);
    return;
  }
...
class UrlShortenServiceConcurrentClient : virtual public UrlShortenServiceIf {
 ...
 public:
  ...
  void ComposeUrls(std::vector<Url> & _return, const int64_t req_id, const std::vector<std::string> & urls);
  int32_t send_ComposeUrls(const int64_t req_id, const std::vector<std::string> & urls);
