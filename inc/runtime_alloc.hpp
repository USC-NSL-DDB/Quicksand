...
public:
  ...
  template <typename U> struct rebind { typedef RuntimeAllocator<U> other; };
  ...
  template <typename U> RuntimeAllocator(const RuntimeAllocator<U> &o) noexcept;
  template <typename U>
  RuntimeAllocator &operator=(const RuntimeAllocator<U> &o) noexcept;
  template <typename U> RuntimeAllocator(RuntimeAllocator<U> &&o) noexcept;
  template <typename U>
...
#include "impl/runtime_alloc.ipp"
